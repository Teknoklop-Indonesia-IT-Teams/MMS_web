...
const CMDashboard: React.FC<CMDashboardProps> = ({
  ...
  const [selectedRecord, setSelectedRecord] = useState<CorRecord | null>(null);
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            onClick={() =>
                              openPdfPreview("corrective", record.id)
                            }
          ...
          <div className="w-full max-w-2xl overflow-hidden bg-white rounded-lg shadow-xl dark:bg-gray-800">
            <div className="flex items-center justify-between p-6 border-b dark:border-gray-700">
              ...
              <div className="flex items-center gap-2">
                <button
                  onClick={() =>
                    openPdfPreview("corrective", selectedRecord.id)
                  }
