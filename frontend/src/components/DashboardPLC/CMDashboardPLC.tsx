...
import { CorRecord, EquipmentPLC } from "../../types";
import { alatPlcService, recordCorrectiveService } from "../../services/api";

interface CMDashboardPLCProps {
...
const CMDashboardPLC: React.FC<CMDashboardPLCProps> = ({
  selectedFilter,
