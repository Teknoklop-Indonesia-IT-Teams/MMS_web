...
interface MaintenanceDashboardPLCProps {
  equipment: EquipmentPLC[];
}

export const MaintenanceDashboardPLC: React.FC<
  MaintenanceDashboardPLCProps
> = ({ equipment }) => {
  ...
  const getWillMatchCategory = (item: EquipmentPLC, category: string) => {
    switch (category) {
      case "selesai":
        return (
...
export default MaintenanceDashboardPLC;
